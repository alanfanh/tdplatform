...
class Project(models.Model):
    ...
    changed = models.CharField(verbose_name=("需求变更次数"),max_length=50, null=True, blank=True)
    # 过程质量
    newbug_percent = models.CharField(verbose_name=("缺陷引入率"), max_length=20, help_text="百分数", null=True, blank=True)
    reopen_count = models.CharField(verbose_name=("缺陷回归不通过数"), max_length=20,help_text="正整数", null=True, blank=True)
    missing_percent = models.CharField(verbose_name=("漏测率"), max_length=20, help_text="百分数", null=True, blank=True)
    nocase_found = models.CharField(verbose_name=("用例外发现bug数"),max_length=20 ,null=True, blank=True)
    test_round = models.CharField(verbose_name=("测试轮次"),max_length=20 ,null=True, blank=True)
    reject_count = models.CharField(verbose_name=("驳回轮次"),max_length=20 ,help_text="正整数", null=True, blank=True)
    ...
    # 效率
    delay = models.CharField(verbose_name=("项目进度偏差"),max_length=20 ,help_text="项目进度偏差天数", null=True, blank=True)
    ...
    day_round = models.CharField(verbose_name=("转测试天数每轮"),max_length=20 ,null=True, blank=True)
    per_version = models.CharField(verbose_name=("平均人力天/B版本"),max_length=50 ,null=True, blank=True)
    # 产品质量
    ...
    pcb_count = models.CharField(verbose_name=("PCB打板次数"),max_length=20 ,null=True, blank=True)
